...
def _get_connector_runner(
    ...
    try:
        runnable_connector = instantiate_connector(
            ...
            source=attempt.connector.source,
            input_type=task,
            connector_specific_config=attempt.connector.connector_specific_config,
...
def run_indexing_entrypoint(
    ...
    try:
        ...
        with Session(get_sqlalchemy_engine()) as db_session:
            ...
            logger.info(
                f"Indexing starting: "
                f"connector='{attempt.connector.name}' "
                f"config='{attempt.connector.connector_specific_config}' "
                f"credentials='{attempt.connector_id}'"
            )
